...
runuser -l haydenshively -c "cd garage && python docker_metaworld_run_cpu.py 'metaworld_launchers/single_task_launchers/sac_metaworld.py --env_name hammer-v2'"
runuser -l haydenshively -c "cd garage/metaworld_launchers && python upload_folders.py sac_round2/hammer-v2 1200"
